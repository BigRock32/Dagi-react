...
import st from './navbarBurger.module.scss'


const NavbarBurger = ({setNav}) => {
   ...
   return (
      <div className={st.nav}>
         <ul className={st.nav__list}>
            <li>
               <NavLink to='/' className={({ isActive }) => isActive ? activeLink : normalLink} onClick={setNav}>
                  Главная
               </NavLink>
            </li>
            <li>
               ...
               <ul className={st.nav__subList}>
                  <div className={st.listWrap}>
                     {services.map((service, index) => {
                        return <ServicesLink index={index} title={service.title} setNav={setNav}/>
                     })}
                  </div>
               </ul>
            </li>
            <li>
               <NavLink to='/projects' className={({ isActive }) => isActive ? activeLink : normalLink} onClick={setNav}>
                  Проекты
               </NavLink>
            </li>
            <li>
               <NavLink to='/contacts' className={({ isActive }) => isActive ? activeLink : normalLink} onClick={setNav}>
                  Конткаты
               </NavLink>
            </li>
         </ul>
