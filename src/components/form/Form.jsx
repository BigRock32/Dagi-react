   ...
   return (
      <form ref={form} onSubmit={sendEmail} name='popupForm' className={st.form}>
         ...
         <div className={`${st.form__item} ${st.form__item_first}`}>
            <input
               id="formName" type="text" name="name" placeholder=" " className={`${st.form__input} _req`} required />
         ...
         <div className={st.form__item}>
            <input
               id="formEmail" type="text" name="email" placeholder=" " className={`${st.form__input} _req _email`} required />
